...
/**
 * Just enough system context to place Luke on a Mac. The desktop itself is a
 * real photograph rather than a hand-drawn imitation, and the bar avoids
 * miniature controls that would compete with the product surface.
 */
function MacDesktop(): React.JSX.Element {
  return (
    <div className="mac-desktop" aria-hidden="true">
      <div className="mac-menu-bar">
        <span className="mac-menu-leading">
        ...
        <span className="mac-menu-trailing">
