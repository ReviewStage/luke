...
/**
 * The provider marks the hero mock draws, ported from
 * `apps/desktop/src/renderer/provider-marks.tsx` — the five the smoke fixture
 * uses, plus the badge that rides them. Keep the two files in step when a
 * provider publishes an updated mark.
 *
