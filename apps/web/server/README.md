...
`pnpm build`, each bundle inlined whole: the workspace packages and every
declared runtime dependency alike, so a function carries what it loads and
nothing is left for a tracer to find. Handed TypeScript, the builder compiled
