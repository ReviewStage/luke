...
/**
 * Runs one of the read prefetch's two small inferences on the hosted brain
 * contract, for a signed-in client, on the key this deployment holds. The
 * contract lives behind the group in `server/brain-app.ts`; this file only
