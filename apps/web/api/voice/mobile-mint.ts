...
import { handleMobileVoiceMint } from "../../server/hosted/mobile-voice-mint.js";
 ...
 * item. The logic lives in `server/hosted/mobile-voice-mint.ts`; this file
 * only hands it the deployment's real seams.
 */
export default {
  fetch(request: Request): Promise<Response> {
    return handleMobileVoiceMint({
      request,
