...
/// route), `packages/hosted/fixtures/json-schema/` and
/// `packages/live/fixtures/json-schema/` (the JSON Schema each wire
/// declaration emits, one file per schema). Both languages decode the
...
enum RepositoryFixtures {
    ...
    static let liveJsonSchema = "packages/live/fixtures/json-schema"
