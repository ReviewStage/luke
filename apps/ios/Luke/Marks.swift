...
/// a colour, so they take the light form a dark surface takes, like GitHub.
struct ProviderMark: View {
    ...
    // The desktop's --mark-conductor, --mark-jules, and --mark-replicas values.
    private static let conductorInk = Color(red: 0xEA / 255, green: 0xE8 / 255, blue: 0xE6 / 255)
    ...
    private static func art(for provider: VaultProviderID) -> MarkArt {
        ...
        case .copilot:
            MarkArt(width: 24, height: 24, color: .white, opticalScale: 0.94, paths: [
        ...
        case .devin:
            MarkArt(width: 425, height: 425, color: .white, opticalScale: 1.22, paths: [
