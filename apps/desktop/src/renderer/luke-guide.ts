  ...
  const facts: AppGuideFact[] = [
    ...
    },
    {
      ...
      detail:
        ...
        "recent transcript — Claude Code, Codex, Gemini CLI, Grok Build, OpenCode, and the Devin " +
        "and Cursor agents running on this machine today — and answer from it. Cursor keeps tool outputs out of its own " +
