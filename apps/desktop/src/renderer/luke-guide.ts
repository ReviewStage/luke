      ...
      ? [
          ...
          },
          {
            ...
            detail:
              ...
              "it, and asks whether they need anything. The Mac decides it is owed and " +
              "opens a muted session for it; Luke's service speaks it from a fixed " +
              "script the moment that session starts, given only the first name. It " +
              "names no session, can act on nothing, waits while a meeting or the " +
              "Announce switch holds it, and is not repeated within the same run.",
          },
          {
            // A behavior rather than a setting, on the arrival beat's terms:
