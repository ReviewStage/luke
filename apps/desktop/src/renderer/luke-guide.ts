  ...
  const facts: AppGuideFact[] = [
    ...
    },
    {
      ...
      detail:
        ...
        "OpenCode, and the Devin and Cursor agents running on this machine today — and answer from it. Cursor keeps tool outputs out of its own " +
        "transcripts, and Antigravity's are stored where Luke does not read them, so those " +
        "readings carry the words and the calls but no results. " +
