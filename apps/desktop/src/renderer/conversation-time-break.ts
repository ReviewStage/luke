 ...
 */
export function opensConversationTimeBreak(
 ...
 */
export function createConversationTimeBreakFormatter({
  locale,
  timeZone,
}: ConversationTimeBreakFormatterOptions = {}): (
  recordedAt: number,
  now: number,
) => ConversationTimeBreakLabel {
