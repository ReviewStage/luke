...
interface EffectActionHandler<TArguments extends readonly unknown[], TResult> {
...
export function createEffectActionHandler(host: ActionHandlerHost) {
  return <TArguments extends readonly unknown[], TResult>(
    channel: string,
    action: EffectActionHandler<TArguments, TResult>,
  ): void => {
