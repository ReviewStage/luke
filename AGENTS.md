...
- `pnpm release:macos` — create a local signed, notarized, and verified
...
- The one thing Luke may change about a session is what the user just asked to
  ...
  (Claude Code, Codex, Gemini CLI, OpenCode, and the Devin and Cursor agents
  running on this machine today); a cloud
