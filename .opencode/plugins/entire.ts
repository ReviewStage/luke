...
export const EntirePlugin: Plugin = async ({ directory }) => {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: OpenCode does not export a per-message-type shape; this plugin only reads a handful of known fields off it.
      ...
      try {
        switch (event.type) {
          case "session.created": {
            // biome-ignore lint/suspicious/noExplicitAny: OpenCode's event type does not discriminate `properties` by event.type.
