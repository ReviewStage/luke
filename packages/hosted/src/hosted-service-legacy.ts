...
/**
 * The wire readers exactly as they stood before they became schema
 * declarations, off the barrel and read by nothing but `wire-migration.test.ts`,
 * which asserts the new declarations answer what these answered over a corpus
 * of well-formed, malformed, and boundary values. It goes the moment the last
 * reader has moved.
 */
