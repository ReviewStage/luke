 ...
 * process, which reads, decides, and acts behind its own validators. The tool
...
export async function askBrain(
  ...
  // already in History. The moment is captured first: a Clear or a withdrawn
  // generation while the wait is held means words granted to it are not said —
  // the follow-up hears the pending note, and History holds nothing of the
