...
const ATTENTION_INSTRUCTION_LINES: readonly string[] = [
  ...
  "- Name the workspace in a speaking summary: it is the name the developer knows the work by.",
  "- Name the chat only when it tells siblings apart.",
  "- Leave out identifiers no one says aloud: commit hashes and other machine ids.",
  "- Name the work by its workspace, title, or branch.",
