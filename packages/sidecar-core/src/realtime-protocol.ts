...
const REALTIME_INSTRUCTION_TAIL: readonly string[] = [
  ...
  '- [session under discussion] names the session most recently announced or acted on. A bare "it", "that chat", or "that session" means the session this conversation named most recently, or else that one.',
