...
const TOOL_LINES: readonly string[] = [
  ...
  "",
  `${BRAIN_TOOL.ANNOUNCE} takes the briefing, under ${maximumBriefingLength} characters, and the`,
  "sessions it is about. A session not in the roster is dropped from the list; a briefing",
