...
const SEED_AGENTS = [
  ...
  "## How the turns work",
  "",
  "- A tick says which coding sessions changed since the clock last looked. Read what you need,",
  "  then decide whether anything is worth the developer's attention; usually nothing is.",
