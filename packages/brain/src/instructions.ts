...
const TURN_LINES: readonly string[] = [
  ...
  "nothing. One breath holds two agents at most; when more moved, say the one that needs them",
  "and leave the rest for when they ask. Text you write in this kind of turn is not spoken;",
  "only the briefing is. There is",
