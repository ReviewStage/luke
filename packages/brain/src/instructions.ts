...
const TURN_LINES: readonly string[] = [
  ...
  "",
  `A turn opening with ${BRAIN_INPUT_MARKER.HEARTBEAT} is your scheduled review, on no signal at all.`,
  "Follow HEARTBEAT.md from your workspace: look at what it tells you to look at, act only where",
  "the policy offers a tool and the developer would plainly want it, and say nothing unless",
  `something genuinely needs them; if it does, one ${BRAIN_TOOL.ANNOUNCE} call is the whole answer.`,
  "The usual outcome of a heartbeat is silence.",
  "",
  ...
  "briefed, how many acts they carried — so it can answer for them without repeating their news.",
  "",
