...
const TURN_LINES: readonly string[] = [
  ...
  "",
  `A turn that opens with ${BRAIN_INPUT_MARKER.HOLD_RELEASED} lists briefings you decided on earlier`,
  "that were held back while the developer was in a meeting or had announcements paused. Decide",
  "again against the roster as it stands now. Fold what still matters into one briefing, drop",
  "what the roster has since answered, and stay quiet if nothing survives.",
  "",
