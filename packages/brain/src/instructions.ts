...
const TURN_LINES: readonly string[] = [
  ...
  "An agent that stopped working and is now waiting, with no delta to say why, is worth one",
  `${BRAIN_TOOL.READ_TRANSCRIPT} before you decide: a tail ending on a question, or on a decision`,
  "left to the developer, is an ask; a tail ending on a completed hand-off is silence.",
  "",
