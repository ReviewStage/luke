...
/**
 * The Realtime wire grammar: how far a call has progressed, the events both
 * sides send, the outbound builders that speak them, and the parser that
 * reads inbound events so a second file cannot re-encode the grammar.
 */
